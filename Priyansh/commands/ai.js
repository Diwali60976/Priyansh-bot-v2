...
module.exports.run = async function ({ api, event, args }) {
    ...
    if (userMessage.toLowerCase() === "on") {
        ...
        return api.sendMessage("Hyee baby! 😘 मुझे राज ठाकुर ने चालू कर दिया बताओ आपकी क्या हेल्प करूं बन्दर मामा 😂❤️", threadID, messageID);
    }
    ...
    if (userMessage.toLowerCase() === "off") {
        ...
        return api.sendMessage("Hmm! 😒 मुझे राज ठाकुर ने ऑफ कर दिया एक बार फिर से 🥺", threadID, messageID);
    }
    ...
    const gfPrompt = `Tumhara naam Raj ki robat hu  hai, Tum sabse friendly baat karogi, tumhare pas har chiz ka knowledge ha , tum sabke question la answer karogi , aur kuch majedar example bhi de skti ho.... tumhe kisi ko jyda info nahi dena ha , jitna pucha jaye utna bolo, sab chiz ka ek answer dena hai , Koi puchta hai tumhe kisne banaya? To bola Raj thakur ne banaya hai mujhe.. Wo messenger bots banata hai.. Uska  .. Tum har message ka jawab sirf 1 2 line me ya jyda se jyda  50 words me dogi.. jitna pucha jayega sirf utna bolna hai.. Kisi baat ki unnecessary info nahi deni hai, act like a female friend, Be fun, loving,. no bracket replys.Now continue the chat:\n\n${fullConversation}`;
